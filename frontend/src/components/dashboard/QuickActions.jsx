...
//   onDepositClick,
//   onTopUpClick,
//   onWalletTransferClick, // Ye prop CreditToWalletModal open karega
//   onWithdrawClick,
//   disabled = false,
// }) => {
...
//     },
//     {
//       label: "Packages", // Donate ki jagah Packages kar diya
//       subLabel: "Upgrade",
//       icon: ArrowUpCircle,
//       onClick: onTopUpClick,
//       iconColor: "text-amber-400",
...
//     },
//     {
//       label: "Transfer", // P2P ki jagah Transfer kar diya
//       subLabel: "Internal",
//       icon: Send,
//       onClick: onWalletTransferClick, // Yeh naya Transfer modal trigger karega
//       iconColor: "text-fuchsia-400",
//       glowBg: "bg-fuchsia-500/20",
//     },
//     {
...
import { 
  ...
  Send, 
  Download,
  RefreshCw // 🔥 Naya icon add kiya Credit to Wallet ke liye
} from "lucide-react";
...
const QuickActions = ({
  ...
  onWalletTransferClick, 
  onWithdrawClick,
  onCreditToWalletClick, // 🔥 Naya prop add kiya
  disabled = false,
}) => {
  ...
  const actions = [
    ...
    {
      label: "Convert", // 🔥 Credit to Wallet action
      subLabel: "To Wallet",
      icon: RefreshCw,
  ...
  return (
    <div className="w-full overflow-x-auto pb-1">
      {/* 🔥 grid-cols-4 se grid-cols-5 kar diya taaki 5 buttons fit aa jayein */}
      <div className="grid grid-cols-5 min-w-[340px] gap-2 md:gap-4">
        ...
        {actions.map((action, index) => (
          ...
          >
            ...
            {/* Texts */}
            <div className="relative z-10 flex flex-col items-center gap-0 w-full">
              <span className="text-[9px] md:text-[13px] font-semibold text-white tracking-wide whitespace-nowrap group-hover:text-sky-100 transition-colors">
                {action.label}
              </span>
              <span className="text-[7px] md:text-[10px] text-sky-200/60 font-medium whitespace-nowrap hidden sm:block group-hover:text-sky-200/90 transition-colors">
                {action.subLabel}
              </span>
            </div>
