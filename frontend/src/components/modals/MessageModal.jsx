...
const MessageModal = ({ isOpen, onClose, title, message, type = 'info', zIndex = 99999 }) => {
  if (!isOpen) return null;
  ...
  return (
    // 🔥 FIX: yahan z-index ko dynamic aur highest kar diya gaya hai (style={{ zIndex }})
    <div 
      className="fixed inset-0 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-md animate-in fade-in duration-300"
      style={{ zIndex }} 
    >
