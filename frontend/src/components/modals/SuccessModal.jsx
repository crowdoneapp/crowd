...
//   customMessage = "",
//   source = "",
//   zIndex = 99999, // 🔥 FIXED: Default Z-Index sabse high kar diya (Navbar ke upar)
// }) => {
//   if (!isOpen) return null;
...
//   return (
//     // 🔥 FIXED: Added p-4 so it doesn't touch screen edges on mobile, zIndex applied to root
//     <div className="fixed inset-0 bg-black/90 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-300 font-sans" style={{ zIndex }}>
      
//       {/* 🏆 UNIVERSAL CERTIFICATE LAYOUT */}
//       {/* 🔥 FIXED: Added my-auto and max-h-[95vh] for perfect mobile centering and scrolling */}
//       <div className="relative w-full max-w-2xl my-auto bg-[#020b1c] border-[2px] sm:border-[3px] border-[#d4af37] p-5 sm:p-8 text-white max-h-[95vh] overflow-y-auto hide-scroll shadow-[0_0_40px_rgba(212,175,55,0.15)] outline outline-1 outline-offset-2 outline-[#d4af37] rounded-sm">
        
//         {/* Close Button - 🔥 FIXED: Adjusted for mobile so it's inside the border on small screens */}
//         <button onClick={onClose} className="absolute top-2 right-2 sm:-top-4 sm:-right-4 bg-red-600/20 hover:bg-red-600 text-white p-1.5 rounded-full transition-all border border-red-500/50 z-50">
//           <X size={16} />
//         </button>
...
const SuccessModal = ({
  ...
  customMessage = "",
  source = "",
  zIndex = 999999, // Sabse highest z-index
}) => {
  // 🔥 Hydration and Portal Setup
  ...
  // 🔥 Is code ko portal ke zariye render kiya gaya hai
  const modalContent = (
    <div className="fixed inset-0 bg-black/90 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-300 font-sans" style={{ zIndex }}>
