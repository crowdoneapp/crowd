...
const Dashboard = ({ setModalState }) => {
  ...
  // latestGlobalUsers state removed
  ...
  const fetchUserData = async () => {
    ...
    if (cachedData) {
        try {
            ...
            // latestGlobalUsers parsing removed
    ...
    try {
        ...
        // Silent background fetch for global list removed
        ...
        localStorage.setItem(cacheKey, JSON.stringify({
            ...
            income: newIncome
            // latestGlobalUsers save removed
        }));
    ...
    <div className="w-full relative animate-fadeIn pb-28 md:pb-8 bg-[#f8fafc] min-h-screen selection:bg-blue-500/20 selection:text-blue-900">
      ...
      */}
      ...
      <div className="space-y-6 md:space-y-8 relative z-10 px-2 sm:px-4 md:px-0 pt-4">
        ...
        {/* Live Global Community Section Removed */}
