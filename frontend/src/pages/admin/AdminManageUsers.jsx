...
import { Search, UserCog, X, Crown, ShieldAlert, ShieldCheck, Cog } from "lucide-react";
                  ...
                  return (
                    <tr key={idx} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-2 border text-center">
                        ...
                        {/* 🔥 SUPER LEADER, LEADER, SETUP, & SUPER SETUP BADGES 🔥 */}
                        ...
                        ) : safeRole === 'super_setup' ? (
                           <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded text-[10px] font-bold uppercase border bg-indigo-100 text-indigo-800 border-indigo-200">
                             <ShieldCheck size={12}/> Super Setup
                           </span>
                        ) : safeRole === 'setup' ? (
                           <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded text-[10px] font-bold uppercase border bg-blue-100 text-blue-800 border-blue-200">
                             <Cog size={12}/> Setup
                           </span>
                        ) : (
             ...
             <form onSubmit={handleUpdateRole} className="space-y-4">
                <div>
                   ...
                   <select value={newRole} onChange={e => setNewRole(e.target.value)} className="w-full border rounded-lg px-4 py-3 font-bold uppercase outline-none">
                      ...
                      <option value="leader">Leader (+$30 Bonus)</option>
                      <option value="superleader">Super Leader (VIP, No bonus)</option>
                      
                      {/* 🔥 NEW ROLES ADDED HERE 🔥 */}
                      <option value="setup">Setup (+$30 Bonus)</option>
                      <option value="super_setup">Super Setup (+$30 Bonus)</option>
                   </select>
