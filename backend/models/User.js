...
const userSchema = new mongoose.Schema({
  ...
  // 👉 NAYI FIELDS: Naye Promo $100 Package ke ROI ke liye 👈
// =========================================================================
  // 📈 NAYI FIELDS: 5% Daily Trade Income & 1% Team Compounding Income ke liye
  // =========================================================================
  roiIncome: { type: Number, default: 0 }, // Ye 5% Daily Trade Income hai
  totalRoiIncome: { type: Number, default: 0 }, 
  
  matchingRoiIncome: { type: Number, default: 0 }, // Ye 1% Team Compounding Income hai
  totalMatchingRoiIncome: { type: Number, default: 0 },
